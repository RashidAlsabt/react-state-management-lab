    ...
    <div>
      ...
      <ul style={{ display: 'flex', flexWrap: 'wrap', gap: '1rem', padding: 0 }}>
        {zombieFighters.map(f => (
          <li key={f.id} style={{ listStyle: 'none', border: '1px solid #ccc', padding: '1rem', width: '150px', textAlign: 'center' }}>
            <img src={f.img} alt={f.name} style={{ width: '100px', height: '100px' }} />
            <p>{f.name}</p>
            <p>Price: {f.price}</p>
